...
const Accordion = ({ title, content }:{title:string,content:string}) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      >
        <div
          className="py-3 px-3 text-white bg-opacity-20 backdrop-blur-sm border-[1px] md:text-base text-xs border-solid translate-x-4 border-white rounded-md scale-y-110 max-w-96 will-change-transform"
        >
          {content}
        </div>
      </div>
